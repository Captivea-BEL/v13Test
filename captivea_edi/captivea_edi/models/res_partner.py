...
SHIP_TO_TYPE_SELECTION = [('DC', 'Warehouse Number'),
                          ('SN', 'Store Number'),
                          ('TPSO', 'Dropship TPSO'),
                          ('RDC', 'Warehouse RDC'),
                          ('DO', 'Dropship DO')]
...
class ResPartner(models.Model):
    ...
    x_edi_accounting_id = fields.Char('Trading Partner ID')
    ...
    edi_asn_single = fields.Boolean(default=False, string='Consolidate 856')
