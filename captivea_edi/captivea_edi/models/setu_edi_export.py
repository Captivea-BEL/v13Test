...
class SHIPACKExport(models.Model):
    ...
    bill_of_landing = fields.Char('Bill Of Landing')
...
class INVACKExport(models.Model):
    ...
    x_edi_accounting_id = fields.Char(related='edi_log_id.invoice_id.x_edi_accounting_id', string='Trading Partner ID')
